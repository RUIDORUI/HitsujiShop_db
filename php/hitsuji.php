    ...
    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
        ...
        $response .= "
                            <div class='goods_Wrapper'>
                                <div class='goods_Box'>
                                <a href='#' class='goods_Link' data-goodsid = '{$title}'>
